...
-(int)getWeekIntValueWithDate
{
    ...
    NSDateComponents *comps= [calendar components:(NSYearCalendarUnit |
                                                   ...
                                                   NSDayCalendarUnit |
                                                   NSWeekdayCalendarUnit) fromDate:self];
    NSLog(@"%ldQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ",(long)[comps weekday]);
...
-(NSString *)compareIfTodayWithDate
{
    ...
    if (comps_today.year == comps_other.year &&
        ...
        //return @"今天";
        return [NSString stringWithFormat:@"今天 %@",[NSDate getWeekStringFromInteger:weekIntValue]];
        
    }else if (comps_today.year == comps_other.year &&
              comps_today.month == comps_other.month &&
              (comps_today.day - comps_other.day) == -1){
        return [NSString stringWithFormat:@"明天 %@",[NSDate getWeekStringFromInteger:weekIntValue]];
        
    }else if (comps_today.year == comps_other.year &&
              comps_today.month == comps_other.month &&
              (comps_today.day - comps_other.day) == -2){
        return [NSString stringWithFormat:@"后天 %@",[NSDate getWeekStringFromInteger:weekIntValue]];
